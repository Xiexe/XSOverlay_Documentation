...
OSC (Open Sound Control) is a protocol used for communicating between applications. XSOverlay, by default, is configured to send OSC messages on port `9000`. XSOverlay does not listen for OSC messages.
